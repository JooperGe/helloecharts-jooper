...
public class SpeedChartActivity extends Activity {
	...
	public static class PlaceholderFragment extends Fragment {
		...
		private void generateSpeedData() {
			// I got speed in range (0-55) and height in meters in range(200 -
			...
			values = new ArrayList<PointValue>();
			for (int i = 0; i < numValues; ++i) {
				// Some random speed values, add +20 to make line a little more
				// natural.
			...
			// Speed axis
			data.setAxisYLeft(new Axis().setName("Speed [km/h]")
					.setHasLines(true).setMaxLabelChars(3)
			...
			data.setAxisYRight(new Axis().setName("Height [m]")
					.setMaxLabelChars(3).setTextColor(ChartUtils.COLOR_BLUE)
