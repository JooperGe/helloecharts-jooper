...
public class ViewPagerChartsActivity extends Activity implements
...
//		android.support.v4.app.FragmentManager temperature = getFragmentManager();
//		mSectionsPagerAdapter = new SectionsPagerAdapter(temperature);
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(
					R.layout.fragment_view_pager_charts, container, false);
			...
			case 1:
				 ...
				 * mode.
				 **/
				lineChartView.setContainerScrollEnabled(true,
			...
			case 2:
				 ...
				 * mode.
				 **/
				columnChartView.setContainerScrollEnabled(true,
						ContainerScrollType.HORIZONTAL);

				layout.addView(columnChartView);
				break;
			case 3:
				BubbleChartView bubbleChartView = new BubbleChartView(
						getActivity());
				 ...
				 * mode.
				 **/
				bubbleChartView.setContainerScrollEnabled(true,
						ContainerScrollType.HORIZONTAL);

				layout.addView(bubbleChartView);
				break;
			case 4:
				PreviewLineChartView previewLineChartView = new PreviewLineChartView(
						getActivity());
				previewLineChartView
						.setLineChartData(generatePreviewLineChartData());

				/**
				 * Note: Chart is within ViewPager so enable container scroll
				 * mode.
				 **/
				previewLineChartView.setContainerScrollEnabled(true,
						ContainerScrollType.HORIZONTAL);

				Viewport tempViewport = new Viewport(
						previewLineChartView.getMaximumViewport());
			...
			case 5:
				 ...
				 * mode.
				 **/
				pieChartView.setContainerScrollEnabled(true,
						ContainerScrollType.HORIZONTAL);
		...
		private BubbleChartData generateBubbleChartData() {
			...
			for (int i = 0; i < numBubbles; ++i) {
				BubbleValue value = new BubbleValue(i,
		...
		private PieChartData generatePieChartData() {
			...
			for (int i = 0; i < numValues; ++i) {
				values.add(new SliceValue((float) Math.random() * 30 + 15,
