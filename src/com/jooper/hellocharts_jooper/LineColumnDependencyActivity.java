...
public class LineColumnDependencyActivity extends Activity {
	...
	public static class PlaceholderFragment extends Fragment {
		public final static String[] months = new String[] { "Jan", "Feb",
		...
		/**
		 * Generates initial data for line chart. At the begining all Y values
		 * are equals 0. That will change when user will select value on column
		 * chart.
		 */
		private void generateInitialLineData() {
			...
			// For build-up animation you have to disable viewport
			// recalculation.
			chartTop.setViewportCalculationEnabled(false);

			// And set initial max viewport and current viewport- remember to
			// set viewports after data.
